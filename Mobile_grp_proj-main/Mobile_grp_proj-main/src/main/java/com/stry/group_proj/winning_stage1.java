...
public class winning_stage1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int currentLevel = intent.getIntExtra("level", 11);
    ...
    protected void onNextLevelButtonClicked(int currentLevel) {
        ...
        Intent intent = new Intent(winning_stage1.this, c4_bomb_game2.class);
        startActivity(intent);
        finish(); // 关闭当前界面
    }
    ...
    protected void onMenuButtonClicked() {
        Intent intent = new Intent(winning_stage1.this, MainMenu.class);
        startActivity(intent);
        finish();
    }
}